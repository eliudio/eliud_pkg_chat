...
typedef MemberHasChatChanged = Function(String? value, int? privilegeLevel,);
...
widgets.add(value.memberId != null ? Center(child: StyleRegistry.registry().styleWithApp(app).frontEndStyle().textStyle().text(app, context, value.memberId)) : Container());
return widgets;
}
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'memberHasChats', widget.value, (newValue, _) {
                  setState(() {
