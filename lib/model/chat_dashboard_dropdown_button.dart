...
typedef ChatDashboardChanged(String? value, int? privilegeLevel,);
...
class _ChatDashboardDropdownButtonWidgetState extends State<ChatDashboardDropdownButtonWidget> {
...
var app = widget.app;
var widgets = <Widget>[];
widgets.add(value.description != null ? Center(child: text(app, context, value.description!)) : Center(child: text(app, context, value.documentID)));
return widgets;
}
        ...
        return ListView(
          ...
          if (value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'chatDashboards', value, (newValue, _) {
                  setState(() {
                    value = value;
                  });
                });
