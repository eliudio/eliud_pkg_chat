...
typedef ChatMemberInfoChanged(String? value);
...
class ChatMemberInfoDropdownButtonWidget extends StatefulWidget {
  ...
  ChatMemberInfoDropdownButtonWidget({ this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
widgets.add(value.authorId != null ? Center(child: StyleRegistry.registry().styleWithContext(context).frontEndStyle().textStyle().text(context, value.authorId!)) : Container());
return widgets;
}
      ...
      if (state is ChatMemberInfoListLoading) {
        ...
        DropdownButton button = 
                    DropdownButton<String>(
                      ...
                      items: items,
                      value: valueChosen,
                      hint: Text('Select a chatMemberInfo'),
