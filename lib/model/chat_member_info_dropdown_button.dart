...
typedef ChatMemberInfoChanged = Function(String? value, int? privilegeLevel,);
...
class ChatMemberInfoDropdownButtonWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return ChatMemberInfoDropdownButtonWidgetState();
  }
}

class ChatMemberInfoDropdownButtonWidgetState extends State<ChatMemberInfoDropdownButtonWidget> {
  ChatMemberInfoListBloc? bloc;

  ChatMemberInfoDropdownButtonWidgetState();
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'chatMemberInfos', widget.value, (newValue, _) {
                  setState(() {
