...
typedef ChatChanged(String? value);
...
class ChatDropdownButtonWidget extends StatefulWidget {
  ...
  ChatDropdownButtonWidget({ this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ChatDropdownButtonWidgetState();
  }
}

class ChatDropdownButtonWidgetState extends State<ChatDropdownButtonWidget> {
  ChatListBloc? bloc;

  ChatDropdownButtonWidgetState();
...
widgets.add(value.saying != null ? Center(child: StyleRegistry.registry().styleWithContext(context).frontEndStyle().textStyle().text(context, value.saying!)) : Container());
return widgets;
}
