...
class ChatCache implements ChatRepository {
  ...
  /// Add a ChatEntity to the repository, cached
  @override
  ...
  /// Delete a ChatModel from the repository, cached
  @override
  ...
  /// Retrieve a ChatModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<ChatModel?>
  @override
  ...
  @override
  StreamSubscription<List<ChatModel?>> listen(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  @override
  StreamSubscription<List<ChatModel?>> listenWithDetails(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  static Future<ChatModel> refreshRelations(ChatModel model) async {
    List<ChatMediumModel>? chatMediaHolder;
    if (model.chatMedia != null) {
      chatMediaHolder = List<ChatMediumModel>.from(
              await Future.wait(model.chatMedia!.map((element) async {
        return await ChatMediumCache.refreshRelations(element);
      })))
          .toList();
    }

    return model.copyWith(
      chatMedia: chatMediaHolder,
    );
  }
}
