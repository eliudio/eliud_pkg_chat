...
class ChatHelper {
  Widget openForMember(
      AppModel app, String thisMemberId, String otherMemberId) {
    return BlocProvider<ChatBloc>(
        ...
        child:
            ChatWidget(app: app, memberId: thisMemberId, canAddMember: false));
  }

  Widget openForMembers(
      AppModel app, String thisMemberId, List<String> otherMemberIds) {
    return BlocProvider<ChatBloc>(
        create: (context) => ChatBloc(
              thisMemberId: thisMemberId,
              appId: app.documentID,
