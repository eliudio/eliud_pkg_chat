                                ...
                                builder: (context, snapshot) {
                                  ...
                                  if (snapshot.connectionState ==
                                    ...
                                    if ((list != null) && (list.isNotEmpty)) {
                                      var memberValue = list.firstWhere(
                                          (element) =>
                                              element!.authorId ==
                                              widget.memberId,
                                          orElse: () => null);
                                  ...
                                  return member(
                                      context, true, timestampRoom, value);
                                });
                          })),
                  if (theRoom != null) buildRoom(theRoom!.documentID!) else Container()
                ],
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            return ListTile(
                onTap: () async {
                  _setRoom(room);
//                  ChatPage.openRoom(context, room, widget.memberId);
                },
                trailing: text(context,
                    timestampRoom != null ? formatHHMM(timestampRoom) : 'now'),
                leading: Container(
                  height: 100,
                  width: 100,
  ...
  @override
  Widget buildRoom(String roomId) {
              ...
              for (var value in values) {
                if (value!.authorId != widget.memberId) {
                  ...
                  if ((otherMemberLastRead == null) ||
                      (otherMemberLastReadThisOne
                              .compareTo(otherMemberLastRead) <
                          0)) {
...
*/
                    ...
                    BlocProvider.of<RoomListBloc>(context).add(UpdateRoomList(
